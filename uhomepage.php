...
<body>
    ...
    <div style="background-color:white;padding:30px;">
        ...
        <p class="welcome-text"><b>Hi  <?php echo $a; ?>.....</b></p>
    ...
    <div class="main">
        ...
        <span style="font-size:25px;font-weight:bold;">Registers You are In-Charge<hr style="margin:10px; margin-bottom:30px;"></span>
...
<hr>
<span style="font-size:20px;font-weight:bold;"><a href="cpwd.php">* Change Password</a></span><br>
<span style="font-size:20px;font-weight:bold;"><a href="report.php">* Generate Report</a></span>
